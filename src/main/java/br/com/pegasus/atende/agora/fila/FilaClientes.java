...
import static br.com.pegasus.atende.agora.pessoa.PessoaStatic.IDADO_MAX_VELHO;
	...
	public FilaClientes(int tempo, int chance) {
		...
		ro = new RotinaObjeto(tempo) {
			...
			protected void rotina() {
				...
				if (br.com.pegasus.atende.agora.utilitarios.Geral.RANDOM.nextInt(100) < chanceTeste) {
					add(new Cliente());
				}
			}
